...
| 🏷️ 分类 | 📝 绩效管理 |
| 📊 等级 | 🌱 新兴项目 |
| 🔗 链接 | [https://github.com/levnikolaevich/claude-code-skills](https://github.com/levnikolaevich/claude-code-skills) |
...
| 🏷️ 分类 | 🤖 HR 聊天机器人 |
| 📊 等级 | 🌱 新兴项目 |
| 🔗 链接 | [https://github.com/stepanogil/autonomous-hr-chatbot](https://github.com/stepanogil/autonomous-hr-chatbot) |

> An autonomous HR agent that can answer user queries using tools

### 3. lookr-fyi/job-application-bot-by-ollama-ai
...
| 🏷️ 分类 | 📄 简历/简历筛选 |
| 📊 等级 | 🌱 新兴项目 |
| 🔗 链接 | [https://github.com/lookr-fyi/job-application-bot-by-ollama-ai](https://github.com/lookr-fyi/job-application-bot-by-ollama-ai) |

> The world’s #1 end-to-end job agent: semantic filters, ATS-optimized resumes, referrals from hiring managers — 100% hands-free.

### 4. Paramchoudhary/ResumeSkills
...
| 🏷️ 分类 | 📄 简历/简历筛选 |
| 📊 等级 | 🌱 新兴项目 |
| 🔗 链接 | [https://github.com/Paramchoudhary/ResumeSkills](https://github.com/Paramchoudhary/ResumeSkills) |
...
| 🏷️ 分类 | 📄 简历/简历筛选 |
| 📊 等级 | 🌱 新兴项目 |
| 🔗 链接 | [https://github.com/molyswu/hand_detection](https://github.com/molyswu/hand_detection) |
...
| 🏷️ 分类 | 🎯 招聘/人才获取 |
| 📊 等级 | 🌱 新兴项目 |
| 🔗 链接 | [https://github.com/nirholas/XActions](https://github.com/nirholas/XActions) |
...
#### 1. levnikolaevich/claude-code-skills ⭐454

- **分类**：📝 绩效管理
- **简介**：Plugin suite + bundled MCP servers for Claude Code. Full delivery lifecycle: Agile pipeline with multi-model AI review, 
- **Forks**：63　|　**语言**：JavaScript　|　**最近更新**：2026-05-07
- **项目地址**：[https://github.com/levnikolaevich/claude-code-skills](https://github.com/levnikolaevich/claude-code-skills)

#### 2. stepanogil/autonomous-hr-chatbot ⭐444

- **分类**：🤖 HR 聊天机器人
- **简介**：An autonomous HR agent that can answer user queries using tools
- **Forks**：110　|　**语言**：Python　|　**最近更新**：2026-05-07
- **项目地址**：[https://github.com/stepanogil/autonomous-hr-chatbot](https://github.com/stepanogil/autonomous-hr-chatbot)

#### 3. lookr-fyi/job-application-bot-by-ollama-ai ⭐436

- **分类**：📄 简历/简历筛选
- **简介**：The world’s #1 end-to-end job agent: semantic filters, ATS-optimized resumes, referrals from hiring managers — 100% hand
- **Forks**：34　|　**语言**：Unknown　|　**最近更新**：2026-05-05
- **项目地址**：[https://github.com/lookr-fyi/job-application-bot-by-ollama-ai](https://github.com/lookr-fyi/job-application-bot-by-ollama-ai)

#### 4. Paramchoudhary/ResumeSkills ⭐426

- **分类**：📄 简历/简历筛选
- **简介**：A collection of AI agent skills focused on resume optimization, job applications, and career development. Built for job 
- **Forks**：40　|　**语言**：Unknown　|　**最近更新**：2026-05-07
- **项目地址**：[https://github.com/Paramchoudhary/ResumeSkills](https://github.com/Paramchoudhary/ResumeSkills)

#### 5. molyswu/hand_detection ⭐274

- **分类**：📄 简历/简历筛选
- **简介**：using Neural Networks (SSD) on Tensorflow.  This repo documents steps and scripts used to train a hand detector using Te
- **Forks**：85　|　**语言**：Python　|　**最近更新**：2026-05-01
- **项目地址**：[https://github.com/molyswu/hand_detection](https://github.com/molyswu/hand_detection)

#### 6. nirholas/XActions ⭐242

- **分类**：🎯 招聘/人才获取
- **简介**：⚡ The Complete X/Twitter Automation Toolkit — Scrapers, MCP server for AI agents (Claude/GPT), CLI, browser scripts. No 
- **Forks**：51　|　**语言**：HTML　|　**最近更新**：2026-05-07
- **项目地址**：[https://github.com/nirholas/XActions](https://github.com/nirholas/XActions)
...
- [levnikolaevich/claude-code-skills](https://github.com/levnikolaevich/claude-code-skills) — ⭐454　|　更新于 2026-05-07
- [stepanogil/autonomous-hr-chatbot](https://github.com/stepanogil/autonomous-hr-chatbot) — ⭐444　|　更新于 2026-05-07
- [Paramchoudhary/ResumeSkills](https://github.com/Paramchoudhary/ResumeSkills) — ⭐426　|　更新于 2026-05-07
- [nirholas/XActions](https://github.com/nirholas/XActions) — ⭐242　|　更新于 2026-05-07
- [lookr-fyi/job-application-bot-by-ollama-ai](https://github.com/lookr-fyi/job-application-bot-by-ollama-ai) — ⭐436　|　更新于 2026-05-05

#### 社区参与度 Top 5（按 Fork）

- [stepanogil/autonomous-hr-chatbot](https://github.com/stepanogil/autonomous-hr-chatbot) — 🍴110　|　⭐444
- [molyswu/hand_detection](https://github.com/molyswu/hand_detection) — 🍴85　|　⭐274
- [levnikolaevich/claude-code-skills](https://github.com/levnikolaevich/claude-code-skills) — 🍴63　|　⭐454
- [nirholas/XActions](https://github.com/nirholas/XActions) — 🍴51　|　⭐242
- [Paramchoudhary/ResumeSkills](https://github.com/Paramchoudhary/ResumeSkills) — 🍴40　|　⭐426

### 🏆 推荐优先级

#### 🔴 S 级 — 必须关注

- ⭐⭐⭐⭐⭐ **[stepanogil/autonomous-hr-chatbot](https://github.com/stepanogil/autonomous-hr-chatbot)** — 综合分 99/100　|　🤖 HR 聊天机器人　|　⭐444
- ⭐⭐⭐⭐⭐ **[levnikolaevich/claude-code-skills](https://github.com/levnikolaevich/claude-code-skills)** — 综合分 87/100　|　📝 绩效管理　|　⭐454
- ⭐⭐⭐⭐⭐ **[Paramchoudhary/ResumeSkills](https://github.com/Paramchoudhary/ResumeSkills)** — 综合分 78/100　|　📄 简历/简历筛选　|　⭐426
- ⭐⭐⭐⭐⭐ **[lookr-fyi/job-application-bot-by-ollama-ai](https://github.com/lookr-fyi/job-application-bot-by-ollama-ai)** — 综合分 77/100　|　📄 简历/简历筛选　|　⭐436
- ⭐⭐⭐⭐⭐ **[molyswu/hand_detection](https://github.com/molyswu/hand_detection)** — 综合分 73/100　|　📄 简历/简历筛选　|　⭐274

#### 🟠 A 级 — 强烈推荐

- ⭐⭐⭐⭐ **[nirholas/XActions](https://github.com/nirholas/XActions)** — 综合分 61/100　|　🎯 招聘/人才获取　|　⭐242
